    ...
    function main() {
        ...
        if(typeof (gamepadAPI.axesStatus[1]) != 'undefined'){
            if(typeof (gamepadAPI.axesStatus[0]) != 'undefined'){
                ...
                canvas_context.fillText(`Left Stick: Y: ${gamepadAPI.axesStatus[1]}, X: ${gamepadAPI.axesStatus[0]}`, 500, 500)
                canvas_context.fillText(`Right Stick: Y: ${gamepadAPI.axesStatus[3]}, X: ${gamepadAPI.axesStatus[2]}`, 500, 570)
            }
        }else{

            canvas_context.font = "30px arial"
            canvas_context.fillStyle = "#FFFFFF"
            canvas_context.fillText(`Controller not seen`, 500, 500)
        }
    }
})
window.addEventListener('DOMContentLoaded', (event) => {
